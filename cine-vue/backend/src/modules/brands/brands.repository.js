...
exports.create = (brand_name, logo_url) =>
  db.execute(
    "INSERT INTO cinema_brands (brand_name, logo_url) VALUES (?, ?)",
    [brand_name, logo_url],
  );
exports.update = (id, brand_name, logo_url) =>
  db.execute(
    "UPDATE cinema_brands SET brand_name = ?, logo_url = ? WHERE brand_id = ?",
    [brand_name, logo_url, id],
  );
