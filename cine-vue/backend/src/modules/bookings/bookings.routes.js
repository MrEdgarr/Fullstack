...
const { bookingSchema, bookingStatusSchema, bookingDetailsSchema } = require("./bookings.validation");
...
router.put("/:id/details", validate(bookingDetailsSchema), bookingsController.updateDetails);
